  ...
  if(fileView === 'plate') {
    return (
        <div className="file-plate" onClick={() => openDirHandler(file)}>
          ...
          <div className="file-plate__name">{file.name.split(' ', 6)}</div>

          <div className="file-plate__btns">
            {file.type !== 'dir' && <button onClick={e => downloadClickHandler(e)}
                                            className="file-plate__btn file-plate__download">download</button>}
            <button onClick={(e) => deleteClickHandler(e)} className="file-plate__btn file-plate__delete">delete
            </button>
  ...
  if(fileView === 'list') {
    return (
        <div className="file" onClick={() => openDirHandler(file)}>
          ...
          <div className="file__name">{file.name.split(' ', 3)}</div>
